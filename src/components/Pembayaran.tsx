...
const payments = [
  ...
  { title: 'DP 50%', amount: 185_000_000 },
  { title: 'Termin 1', amount: 92_500_000 },
  { title: 'Termin 2', amount: 92_500_000 },
];
    ...
    <section className="bg-[#445B47] min-h-screen py-16 px-6 text-white">
        ...
        {payments.map((item, index) => (
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-xl font-bold text-[#445B47]">
      ...
      <div className="mt-12">
        ...
        <div className="relative h-3 bg-white/30 rounded-full max-w-2xl mx-auto">
          <div
            className="absolute top-0 left-0 h-3 bg-yellow-300 rounded-full transition-all"
            style={{ width: '100%' }}
          />
        </div>
      ...
      {/* Skema Bagi Hasil Investasi */}
      <div className="mt-24 max-w-4xl mx-auto text-white">
        ...
        <div className="bg-white/10 rounded-2xl px-6 py-8 space-y-4 text-white/90">
          ...
          <div className="border-t border-white/20 pt-6 text-sm text-white/70 italic">
            📝 Catatan: Angka di atas merupakan estimasi berdasarkan asumsi rata-rata okupansi
            dan tarif per bulan. <br />
